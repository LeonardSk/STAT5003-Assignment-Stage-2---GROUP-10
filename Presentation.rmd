...
<!-- Downsampling the data gives better prediction for the two minor classes that we're most interested in, but in the meanwhile lowers the overall accuracy to 43%. The computational time for running the model takes around 15 second.
-->
