...
# saveRDS(xgb.tune, "GBM/xgb_tune_SMOTE_B.rds")
```
...
write_csv(collect_metrics(xgb.tune), "GBM/xgb_tune_SMOTE_B_metrics.csv")
write_csv(best_auc, "GBM/xgb_tune_SMOTE_B_metrics_bestAUC.csv")
write_csv(best_acc, "GBM/xgb_tune_SMOTE_B_metrics_bestACC.csv")
```
...
xgb.model.fit <- xgb.workflow.final %>% 
  fit(data = Train_set)
saveRDS(xgb.model.fit, "GBM/xgb_tune_SMOTE_A_modelfit.rds")
