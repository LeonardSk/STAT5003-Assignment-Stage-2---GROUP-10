...
* HL during the IDA contributed to problem introduction and report compiling. For the report 2, HL worked on developing Random Forest algorithm, and contributed to the Random Forest section and future improvement section in the report.  
* JC
* JS
* LS
