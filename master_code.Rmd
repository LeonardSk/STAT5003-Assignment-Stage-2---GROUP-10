...
```{r echo=FALSE, fig.cap="Figure 1. Missingness summary",  out.width = '100%'}
...
```{r echo=FALSE, fig.cap="Figure 2. Feature Re-categorization",  out.width = '100%'}
...
```{r echo=FALSE, fig.cap="Figure 3. Outliers detection",  out.width = '100%'}
...
```{r echo=FALSE, fig.cap="Figure 4. Outliers detection",  out.width = '100%'}
...
```{r echo=FALSE, fig.cap="Figure 5. 2D Heat Maps",  out.width = '100%'}
knitr::include_graphics("IDA_heat_map.png")
```

## 4. Approach 
The overall methodology of the current study is summarized in Figure 1.
```{r echo=FALSE, fig.cap="Figure 1. The methodology used in the current study.",  out.width = '100%'}
...
```{r echo=FALSE, fig.cap="Figure 1. Class Distribution with different re-sampling techniques", out.width = '100%'}
...
```{r echo=FALSE, fig.cap="Figure 2. The sensitivity of random forest algorithms using different training dataset.", out.width = '60%'}
